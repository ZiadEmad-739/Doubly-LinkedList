...
public:
    ...
    void pop_front(){
        if (!empty()){
            ...
            cout << "Can't delete this item, DoublyLinkedList is empty." << endl;
        }
    }
    ...
    void get_head(){
        if(!empty()){
            ...
            cout << "No Head, DoublyLinkedList is empty" << endl;
        }
    }
    ...
    void search(int item) {
        if (found(item)) {
            ...
            cout << "No " << item << " isn't found " << "DoublyLinkedList is empty or item don't in it" << endl;
        }
    }

    void replace(int curr_item, int new_item) {
        if (empty()) {
            cout << "Can't replace, DoublyLinkedList is empty." << endl;
        } else {
            bool check = false;
            node *curr_ptr = head;
                while (curr_ptr != nullptr) {
    ...
    void is_empty(){
        string check = empty() ? "Yes, DoublyLinkedList is empty" : "No, DoublyLinkedList isn't empty";
        cout << check << endl;
    }

    void join(DoublyLinkedList l){
    ...
    void display(){
        if(!empty()){
            ...
            cout << "Can't display, DoublyLinkedList is empty" << endl;
        }
    }
    ...
    void clear(){
        if(!empty()){
            ...
            cout << "Can't clear, DoublyLinkedList is empty" << endl;
        }
    }
};